...
#SBATCH --output=/share/pi/nigam/mwornow/hf_ehr/slurm_logs/gen_dataset_stats_%A.out
#SBATCH --error=/share/pi/nigam/mwornow/hf_ehr/slurm_logs/gen_dataset_stats_%A.err
