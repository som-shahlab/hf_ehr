#!/bin/bash
#SBATCH --job-name=mamba-1
#SBATCH --output=/share/pi/nigam/mwornow/hf_ehr/slurm_logs/mamba_1_%A.out
#SBATCH --error=/share/pi/nigam/mwornow/hf_ehr/slurm_logs/mamba_1_%A.err
...
# Experiment names
RUN_NAMES=("mamba-tiny-1024--clmbr" "mamba-tiny-4096--clmbr")
RUN_ARGS=(
