#!/bin/bash
#SBATCH --job-name=mamba-2
#SBATCH --output=/share/pi/nigam/mwornow/hf_ehr/slurm_logs/mamba_2_%A.out
#SBATCH --error=/share/pi/nigam/mwornow/hf_ehr/slurm_logs/mamba_2_%A.err
...
# Experiment names
RUN_NAMES=("mamba-tiny-8192--clmbr" "mamba-tiny-16384--clmbr" )
RUN_ARGS=(
