...
#SBATCH --partition=gpu,nigam-v100,nigam-h100,nigam-a100
#SBATCH --mem=200G
...
RUN_ARGS=(
    "python3 main.py --model hyena --size base --tokenizer clmbr --context_length 1024 --dataloader approx --dataset v8"
    "python3 main.py --model hyena --size base --tokenizer clmbr --context_length 4096 --dataloader approx --dataset v8"
    "python3 main.py --model hyena --size base --tokenizer clmbr --context_length 8192 --dataloader approx --dataset v8"
    "python3 main.py --model hyena --size base --tokenizer clmbr --context_length 16384 --dataloader approx --dataset v8"
)
